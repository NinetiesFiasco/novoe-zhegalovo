...
<template>
  <div class="info-transport">
    ...
    <div class="info-text">
      <p>
        <span class="accent font-bold">17км до МКАД:</span> можно проехать за 20
        минутна машине
      </p>
      <p>
      ...
      <p>
        <span class="accent font-bold">Всегда в центре событий:</span> Если вам
        нужно попасть в центр города Щёлково, на это уйдет не более 20 минут.
        Там вас ждут административные учреждения, театры, крупные торговые
        центры и вся городская инфраструктура.
      </p>
    </div>
  </div>
</template>
